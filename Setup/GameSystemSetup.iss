...
OutputBaseFilename=SetupGameSystem
...
Source: "E:\MY_WORK\GameSystem\GameClient\Bin\data.db"; DestDir: "{app}"; Flags: ignoreversion;
Source: "E:\MY_WORK\GameSystem\GameClient\Bin\data.db"; DestDir: "{app}\backup"; Flags: ignoreversion;
Source: "E:\MY_WORK\GameSystem\GameClient\bin\frx\*"; DestDir: "{app}\frx"; Flags: ignoreversion;
Source: "E:\MY_WORK\GameSystem\GameClient\bin\bpl\*"; DestDir: "{app}"; Flags: ignoreversion;
