...
public class BaseAdapterHelper
{
    ...
    {
        if (value == null) value = new SpannableString("");
        TextView view = retrieveView(viewId);
        view.setText(value);
        view.setMovementMethod(LinkMovementMethod.getInstance());//开始响应点击事件
        return this;
    }

    public BaseAdapterHelper appendText(int viewId, String value) {
        if (value == null) value = "";
        TextView view = retrieveView(viewId);
        view.append(value);
        return this;
    ...
    public BaseAdapterHelper setImageUrl(int viewId, String imageUrl, DisplayImageOptions options, ImageLoadingListener listener) {
        ImageView view = retrieveView(viewId);
        ImageLoader.getInstance().displayImage(imageUrl, view, options, listener);
        return this;
    }

    public BaseAdapterHelper setImageFile(int viewId, String filePath) {
        ImageView view = retrieveView(viewId);
        ImageLoader.getInstance().displayImage("file://" + filePath, view);
        return this;
    }

    public BaseAdapterHelper setImageFile(int viewId, String filePath, DisplayImageOptions options) {
        ImageView view = retrieveView(viewId);
        ImageLoader.getInstance().displayImage("file://" + filePath, view, options);
        return this;
    }

    public BaseAdapterHelper setImageDrawable(int viewId, int drawableId, DisplayImageOptions options) {
        ImageView view = retrieveView(viewId);
        ImageLoader.getInstance().displayImage("drawable://" + drawableId, view, options);
        return this;
    }

    public BaseAdapterHelper setImageDrawable(int viewId, int drawableId) {
        ImageView view = retrieveView(viewId);
        ImageLoader.getInstance().displayImage("drawable://" + drawableId, view);
        return this;
    }
